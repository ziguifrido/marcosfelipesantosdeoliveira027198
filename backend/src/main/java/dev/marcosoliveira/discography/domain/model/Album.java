...
public class Album extends AbstractAggregateRoot<Album> {
    ...
    public static Album record(String title, LocalDate releaseDate, ImageReference cover, Set<Artist> artists) {
        validate(title, releaseDate, cover, artists);
    ...
    public void updateImage(ImageReference cover){
        validate(cover);
        setCover(cover);
    }
    ...
    private static void validate(String title, LocalDate releaseDate, ImageReference cover, Set<Artist> artists) {
        validate(title, releaseDate);
        validate(cover);
        validate(artists);
    }
